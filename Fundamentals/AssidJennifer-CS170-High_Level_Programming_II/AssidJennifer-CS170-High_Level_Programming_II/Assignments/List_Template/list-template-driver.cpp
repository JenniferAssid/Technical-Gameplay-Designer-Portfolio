...
void InUse()
{
    ...
    std::cout << CS170::List_Template<Person>::node_count();
    std::cout << std::endl;
    std::cout << "============================================\n";
    std::cout << std::endl;
}
...
void ListTemplate_TestPushFront()
{
    std::cout << "TestPushFront..." << std::endl;

    int size = 5;
    CS170::List_Template<Person> list;
...
void ListTemplate_TestPushBack()
{
...
void ListTemplate_TestPushFrontBack()
{
...
void ListTemplate_TestPopFront()
{
...
void ListTemplate_TestArray1()
{
    ...
    CS170::List_Template<Person> list(array, size);
...
void ListTemplate_TestCopyConstructor1()
{
    std::cout << "TestCopyConstructor1..." << std::endl;
    int size = 10;
    CS170::List_Template<Person> list1;
    for (int i = 1; i <= size; i++)
    ...
    CS170::List_Template<Person> list2(list1);
    std::cout << "List 2:\n";
    std::cout << list2;
...
void ListTemplate_TestCopyConstructor2()
{
    ...
    const CS170::List_Template<Person> list2(list1);
    std::cout << "List 2:\n";
    std::cout << list2;
...
void ListTemplate_TestAssignment1()
{
    std::cout << "TestAssignment1..." << std::endl;
    int size = 10;
    CS170::List_Template<Person> list1, list2;
    for (int i = 1; i <= size; i++)
        list1.push_front(*PersonRecs[i]);
...
void ListTemplate_TestAssignment2()
{
    std::cout << "TestAssignment2..." << std::endl;
    int size = 10;
    CS170::List_Template<Person> list1, list2, list3;
    for (int i = 1; i <= size; i++)
        list1.push_front(*PersonRecs[i]);
...
void ListTemplate_TestAddition1()
{
    ...
    CS170::List_Template<Person> list3;
    list3 = list1 + list2;
...
void ListTemplate_TestAddition2()
{
    ...
    const CS170::List_Template<Person> list3(list1 + list2);
    std::cout << "List 3:\n";
    std::cout << list3;

    CS170::List_Template<Person> list4;
...
void ListTemplate_TestAddAssign1()
{
...
void ListTemplate_TestAddAssign2()
{
...
void ListTemplate_TestAddAssign3()
{
...
void ListTemplate_TestAddAssign4()
{
...
void ListTemplate_TestSubscript1()
{
...
void ListTemplate_TestSubscript2()
{
