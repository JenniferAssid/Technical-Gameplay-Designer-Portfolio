...
{
    AddSelection("0", _Splitter);
    AddSelection("1", _Sparsevector);
    AddSelection("2", _Sparsevector_CPP);
    AddSelection("3", _Lazycopy);
...
{
    std::cout << "Thank you for checking out Jennifer Assid's work for CS225: Advanced C/C++" << std::endl;
}
