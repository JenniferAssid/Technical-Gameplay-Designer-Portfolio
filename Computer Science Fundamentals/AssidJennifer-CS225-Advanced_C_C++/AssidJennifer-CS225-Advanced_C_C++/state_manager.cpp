...
StateManager::StateManager()
{
    ...
    AddState(_Splitter, new Splitter_Assignment());
    AddState(_Sparsevector, new Sparsevector_Assignment());
    AddState(_Sparsevector_CPP, new Sparsevector_CPP_Assignment());
    AddState(_Lazycopy, new Lazycopy_Assignment());
